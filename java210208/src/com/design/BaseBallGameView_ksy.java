...
public class BaseBallGameView_ksy extends JFrame implements ActionListener{
	//선언부
	////////////   메뉴바 추가하기 ///////////////
	...
	int[] com = new int[3];	
	BaseBallGameLogic_ksy bbGLogic = new BaseBallGameLogic_ksy();
...
//		jbtns[0].setBackground(newColor);
	...
	//생성자
	public BaseBallGameView_ksy() {
		bbGLogic.nanSu();
		initDisplay();
	}	
	public static void main(String[] args) {
		new BaseBallGameView_ksy();
	}
